import pytest
from medium import Region, Plane, Sphere, Cylinder, Box
from geometry import calculate_nearest_boundary  # Replace with the actual file name where your function resides
