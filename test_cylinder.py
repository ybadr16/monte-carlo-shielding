...
def test_evaluate():
    ...
    cylinder = Cylinder(radius=1, x0=0, y0=0, z0=0, axis="z")
    ...
    cylinder = Cylinder(radius=2, x0=0, y0=1, z0=0, axis="x")
...
def test_edge_cases():
    ...
    large_cylinder = Cylinder(radius=1000, x0=0, y0=0, z0=0, axis="z")
    ...
    degenerate_cylinder = Cylinder(radius=0, x0=0, y0=0, z0=0, axis="z")
